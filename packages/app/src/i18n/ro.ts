export const dict = {
  ...
  "provider.custom.models.fetch.loading": "Fetching models...",
  "provider.custom.models.fetch.success": "Found {{count}} models",
  "provider.custom.models.fetch.failed": "Could not fetch models",
  ...
  "session.promptAnchors.label": "Prompt anchors",
  "session.promptAnchors.jump": "Jump to prompt {{index}}",
  ...
  "session.todo.hide": "Hide task list",
  "session.todo.show": "Show task list",
