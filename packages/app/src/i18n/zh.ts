...
export const dict = {
  ...
  "provider.custom.models.fetch": "获取模型列表",
  "provider.custom.models.fetch.loading": "正在获取模型...",
  "provider.custom.models.fetch.success": "已发现 {{count}} 个模型",
  "provider.custom.models.fetch.failed": "获取模型失败",
  ...
  "session.promptAnchors.label": "提示词锚点",
  "session.promptAnchors.jump": "跳转到第 {{index}} 条提示词",
  "session.context.addToContext": "将 {{selection}} 添加到上下文",
  "session.todo.title": "待办事项",
  "session.todo.collapse": "折叠",
  "session.todo.expand": "展开",
  "session.todo.hide": "隐藏任务列表",
  "session.todo.show": "显示任务列表",
