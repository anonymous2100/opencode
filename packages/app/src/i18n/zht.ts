...
export const dict = {
  ...
  "provider.custom.models.fetch": "取得模型清單",
  "provider.custom.models.fetch.loading": "正在取得模型...",
  "provider.custom.models.fetch.success": "已發現 {{count}} 個模型",
  "provider.custom.models.fetch.failed": "取得模型失敗",
  ...
  "session.promptAnchors.label": "提示詞錨點",
  "session.promptAnchors.jump": "跳轉到第 {{index}} 則提示詞",
  "session.context.addToContext": "將 {{selection}} 新增到上下文",
  "session.todo.title": "待辦事項",
  "session.todo.collapse": "收合",
  "session.todo.expand": "展開",
  "session.todo.hide": "隱藏任務清單",
  "session.todo.show": "顯示任務清單",
